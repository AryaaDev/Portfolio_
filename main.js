...
// Mendeteksi pergerakan scroll
    window.addEventListener('scroll', function() {
        ...
        // Jika layar di-scroll lebih dari 20 pixel ke bawah
        if (window.scrollY > 20) {
            header.classList.add('scrolled'); // Munculkan kapsul kaca
        } else {
            header.classList.remove('scrolled'); // Kembalikan jadi transparan
        }
    });